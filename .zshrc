...
# Use theme pure by @sindresorhus.
...
# Copies the content of a pastebin.
pb() {
  if [ $# -lt 1 ]
  then
    exit 1
  ...
  curl -s "http://pastebin.com/raw.php?i=$1" > tmp
  pbcopy < tmp
  rm tmp
}
...
# FUN
google() {
  open /Applications/Safari.app "http://www.google.fr/?q=$1#safe=off&q=$1"
}
